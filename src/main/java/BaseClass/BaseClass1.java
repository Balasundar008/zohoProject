...
public class BaseClass1 {
	...
	public static void javaScriptExecutorScroll(String x, String y) {
		JavascriptExecutor js= (JavascriptExecutor) driver;
			js.executeScript("window.scrollBy(x, y);");
			
		}
		public static void javaScriptExecutorSC(WebElement element,String options,String x, String y) {
